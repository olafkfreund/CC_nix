...
1. **@.claude/NIX_ANTIPATTERNS.md** - Critical anti-patterns to detect
...
2. **@docs/PATTERNS.md** (if exists in project) - Project-specific best practices
...
**Check Against NIX_ANTIPATTERNS.md:**
...
- NIX_ANTIPATTERNS.md: [Specific sections]
- PATTERNS.md (if exists): [Specific sections]
...
/review
Please review modules/services/myservice.nix
